  ...
  methods: {
    ...
    editPlan(plan) {
      ...
      this.newPlan = {
        ...this.newPlan,
        ...plan,
        php_timeout: Number(plan.php_timeout || 120),
    ...
    planPayload() {
      return {
        ...
        max_processes: Number(this.newPlan.max_processes), php_workers: Number(this.newPlan.php_workers), php_timeout: Number(this.newPlan.php_timeout || 120), bandwidth_mb: Number(this.newPlan.bandwidth_mb),
